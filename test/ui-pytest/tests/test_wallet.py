...
@pytest.mark.parametrize('user_account', [constants.user.user_account_default])
@pytest.mark.parametrize('derivation_path, generated_address_index', [
                          pytest.param('Ethereum', '5'),
                          pytest.param('Ethereum Testnet (Ropsten)', '10'),
                          pytest.param('Ethereum (Ledger)', '15'),
                          pytest.param('Ethereum (Ledger Live/KeepKey)', '20'),
                          pytest.param('N/A', '95')
                          ])
@pytest.mark.parametrize('name, color, emoji, emoji_unicode', [
                          pytest.param('Ethereum', '#216266', 'sunglasses', '1f60e'),
                          pytest.param('Ethereum Testnet', '#7140fd', 'sunglasses', '1f60e'),
                          pytest.param('Ethereum Ledger', '#2a799b', 'sunglasses', '1f60e'),
                          pytest.param('Ethereum Ledger Live', '#7140fd', 'sunglasses', '1f60e'),
                          pytest.param('Custom path', '#216266', 'sunglasses', '1f60e')
                          ])
